...
// ✅ Extend global type definition so TS recognizes our custom property
declare global {
  // eslint-disable-next-line no-var
  var firebaseApp: App | undefined;
}

// ✅ Prevent duplicate initialization (especially in hot-reload)
const app =
  globalThis.firebaseApp ??
  initializeApp({
    credential: cert(serviceAccount as unknown as object),
    storageBucket: "your-project.appspot.com", // 🔁 change to your bucket name
  });
